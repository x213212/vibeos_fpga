...
set direct_out $out_dir/direct
file mkdir $direct_out

puts "DIRECT_SYNTH_BEGIN"
synth_design -top riscv_ps_ddr_wrapper -part xc7z020clg400-1
write_checkpoint -force $direct_out/post_synth.dcp

puts "DIRECT_IMPL_BEGIN"
opt_design
place_design
route_design
write_checkpoint -force $direct_out/post_route.dcp
report_timing_summary -file $direct_out/timing_summary.rpt
write_bitstream -force $direct_out/riscv_ps_ddr_wrapper.bit
