...
set bin_file "H:/testproject/project_2/sdio_probe_readonly.bin"
...
set output_file "H:/testproject/project_2/sdio_probe_readonly_output.txt"
...
puts "SDIO_READONLY_PROBE_RELEASE_CPU"
...
puts ""
puts [format "SDIO_READONLY_PROBE_PRINTED=%d" $printed]
set out_fd [open $output_file w]
puts $out_fd $captured
puts $out_fd [format "SDIO_READONLY_PROBE_PRINTED=%d" $printed]
close $out_fd
disconnect
