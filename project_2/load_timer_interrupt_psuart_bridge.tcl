...
set bin_file "H:/testproject/project_2/timer_interrupt.bin"
...
zero_words [expr {$ddr_load_addr + 0x3000}] 0x1000
...
puts "TIMER_INTERRUPT_PSUART_BRIDGE_RELEASE_CPU"
mwr $cpu_reset_gpio 0x00000001

set printed 0
for {set n 0} {$n < 7000} {incr n} {
...
puts ""
puts [format "TIMER_INTERRUPT_PSUART_BRIDGE_PRINTED=%d" $printed]
