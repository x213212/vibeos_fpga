...
# Keep the board-specific PS UART/MIO setup from the generated init script.
# Manual SLCR/MIO/UART register writes can break the Z7-Lite PS UART path.
source $init_file
ps7_init
...
puts "PSUART_BRIDGE_RELEASE_CPU"
...
puts ""
puts [format "PSUART_BRIDGE_PRINTED=%d" $printed]
